...
let data = [
    ...
    },
    {
        role: "user",
        content:
            "대전에서의 3일 여행 일정을 만들어줘. 일정에 꼭 들어가야하는 장소는 한빛탑이야. 나는 자동차가 없으니 여행 중 이동 거리는 가능한 짧게 계획해줘. 결과는 문장은 제외하고 json으로만 해줘.",
    },
    {
        role: "assistant",
        content: `{"day1":{"오전":"한밭수목원","오후":"대전예술의 전당","저녁":"신세계백화점"},"day2":{"오전":"한빛탑","오후":"대전컨벤션센터","저녁":"둔산동 맛집 탐방"},"day3":{"오전":"시민천문대","오후":"국립중앙과학관","저녁":"기상과학체험공원"}}`,
    },
];
